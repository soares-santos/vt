...
fitscopy $clustercat'[col *;dist2boxcenter(1D)=-999.;id_cand(1J)=id]' tmp.fit
fitscopy tmp.fit'[col -id]' \!$clustercat
fitscopy $clustercat'[col *;id=id_cand*10+1]' \!tmp.fit && mv tmp.fit $clustercat
fitscopy $memberscat'[col *;host_cand(1J)=host_id]' \!tmp.fit
fitscopy tmp.fit'[col -host_id]' \!$memberscat
fitscopy $memberscat'[col *;host_id=host_cand*10+1]' \!tmp.fit && mv tmp.fit $memberscat 
fi
...
fitscopy tmpC.fit'[col *;id_cand(1J)=id]' tmp.fit
fitscopy tmp.fit'[col -id]' \!tmpC.fit
fitscopy tmpC.fit'[col *;id=id_cand*10+2]' \!tmp.fit && mv tmp.fit tmpC.fit
fitscopy tmpM.fit'[col *;host_cand(1J)=host_id]' \!tmp.fit
fitscopy tmp.fit'[col -host_id]' \!tmpM.fit
fitscopy tmpM.fit'[col *;host_id=host_cand*10+2]' \!tmp.fit && mv tmp.fit tmpM.fit
fi
